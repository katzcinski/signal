...
| [`Konzept_Manuelles_Healing.md`](Konzept_Manuelles_Healing.md) | Manuelle Healing-Mechanismen: Parkbucht-Korrektur, Fix-at-Source, Patch-Overlay, Reprocess | Konzept/Evaluierung (2026-08) |
