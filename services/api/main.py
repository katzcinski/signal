...
from .routers import library, objects, runs, lineage, contracts, incidents, proposals, stream, checks, extract, metrics, data_loads, activity, notifications
...
def create_app() -> FastAPI:
    ...
    for router in [library.router, objects.router, runs.router, lineage.router,
                   ...
                   activity.router, notifications.router]:
