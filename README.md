...
| [`docs/ADR-0002_Datasphere-DB-Zugriff.md`](docs/ADR-0002_Datasphere-DB-Zugriff.md) | ADR: DB-Zugriff über technischen Space-User statt Database Analysis User (Vorschlag) |
